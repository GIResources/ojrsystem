...
<?php
    ...
    if(isset($_POST['jobs_submit_btn'])){
        ...
        if(empty($jobcategory || $desiredjobposition)){
           ...
           $query = "INSERT INTO jobs(job_id,jobcategory,desiredjobposition)
                    VALUES('{$job_id}','{$jobcategory}','{$desiredjobposition}')";
    ...
    <div class="container-fluid bg-success">
        ...
        <div class="col-xs-6 col-sm-6 col-md=6">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4><p align="center"><strong class="text-info">JOB CATEGORY SECION</strong></p></h4>
                    </div>
