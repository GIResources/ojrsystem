    ...
    if(isset($_POST['referee_submit_btn'])){
        ...
        if(empty($refname || $refaddress || $refoccupation || $refcontact || $attestation)){
            ...
            $job_id = $acronym . $increase_num;
               ...
               $query = "INSERT INTO app_referee(job_id, refname, refaddress, refoccupation, refcontact, attestation) VALUES('{$job_id}','{$refname}','{$refaddress}','{$refoccupation}','{$refcontact}','{$attestation}')";
