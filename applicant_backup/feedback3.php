    ...
    <div class="container-fluid bg-success">
        ...
        <div class="col-xs-6 col-sm-6 col-md=6">
                <div class="panel panel-danger">
                    ...
                    <hr>
                    <p align="center" style="color:green;"><marquee><strong>Congratulation! Your Educational Qualifications Detail Submission was Successful! Continue filling the next forms!</strong></marquee></p>
                    
                    <p align="center"><a href="app_certificates.php"><input type="submit" name="biodata_submit_btn" value="NEXT FORM" class="btn btn-info" /></a></p>
