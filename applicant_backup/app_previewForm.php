...
FROM jobs
INNER JOIN app_biodataform INNER JOIN qualifications 
ON jobs.id = app_biodataform.id = qualifications.id LIMIT 5") 
...
echo '<b>Job Category:</b>'.'&nbsp;'.'&nbsp;'.'<td>' . $row['jobcategory'] . '</td>' . '<br />';
echo '<b>Job Position:</b>'.'&nbsp;'.'&nbsp;'. '<td>' . $row['desiredjobposition'] . '</td>'. '<br />';
echo '<b>First Name:</b>'.'&nbsp;'.'&nbsp;'.'<td>' . $row['firstname'] . '</td>'. '<br />';
echo '<b>Last Name:</b>'.'&nbsp;'.'&nbsp;'. '<td>' . $row['lastname'] . '</td>'. '<br />';
echo '<b>Qualification:</b>'.'&nbsp;'.'&nbsp;'.'<td>' . $row['highestqualification'] . '</td>'. '<br />';
echo '<b>Discipline:</b>'.'&nbsp;'.'&nbsp;'.'<td>' . $row['discipline'] . '</td>';
