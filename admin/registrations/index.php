...
================================================== -->
    ...
    <div class="container bg-success">
        ...
        <form id="form" method="POST" action="" enctype="multipart/form-data" style="padding-left: 20px; padding-right:20px; color: blue; width:50%; ">
            ...
            <a href="../registrations/viewapps.php"><p align="center"><input type="button" name="admin_reg_submit_btn" value="VIEW APPLICANTS LIST" class="btn btn-warning" /></p></a>
            ...
            <hr>
            <a href="../registrations/printapps.php"><p align="center"><input type="button" name="admin_reg_submit_btn" value="PRINT APPLICANTS LIST" class="btn btn-print" /></p></a>
            <a href="../registrations/printadmins.php"><p align="center"><input type="button" name="admin_reg_submit_btn" value="PRINT ADMINS LIST" class="btn btn-print" /></p></a>
