...
<title>Infosys Administrators' List</title>
<!-- STYLES & JQUERY 
================================================== -->
...
<form style="width: 90%; padding: 10px; margin-left: auto; margin-right: auto; border: 4px solid #dcd;">
    <h4 style="color: white;"><p align="center">LIST OF AUTHORIZED ADMINISTRATORS</p></h4>
<hr>
    <h6 style="color: white;"><p align="justify">The Following List on this Table Shows the Total Number of Administrators who have been designated, delegated and authorized to act on behalf of Infosys Digital to guide and assist Registered Applicants or Jobseeker aspiring through their applications for Job Employment and Placement in/with the company. Infosys Digital Solutions disclaims any other advertised or published Administrators List alleged and masterminded by any other third-party whether individual or corporate organization or site other than these outline by this site and shown on this table. kindly contacts the developer any  assistance you might need.</p></h6>
    <hr> <br /></form>            
...
Displays all data from 'REGISTER ADMIN Table
...
echo "<h5><p align='center' style='color:white;'><b>View All</b> | <a href='../../index.php'><strong>Home</strong></a>&nbsp; | <a href='../registrations/index.php'><strong>Manage Registrations</strong></a></p></h5>";
...
echo "<tr> <th>ID</th> <th>Admin Serial No</th><th>Title</th> <th>First Name</th><th>Last Name</th><th>Phone Contacts</th><th>Email Address</th><th>Gender</th> <th>Registration Date</th><th>Delete Admin</th></tr>";
...
echo '<td><a href="deleteadmins.php?id=' . $row['id'] . '">Delete</a></td>';
echo "</tr>";
...
?>
<hr><hr>
<h5><p align="center"><a href="../../index.php"><strong>Home</strong></a>&nbsp; | <a href="../registrations/index.php"><strong>Manage Registrations</strong></a></p></h5>
    </form>
</body>
