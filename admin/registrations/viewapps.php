...
<title>Infosys Applicants' List</title>
<!-- STYLES & JQUERY 
================================================== -->
...
<form style="width: 90%; padding: 10px; margin-left: auto; margin-right: auto; border: 4px solid #dcd;">
    <h4 style="color: white;"><p align="center">LIST OF REGISTERED APPLICANTS</p></h4>
<hr> 
<h6 style="color: white;"><p align="justify">The Following List on this Table Shows the Total Number of Applicant who have at once or the other Registered on this Site while seeking for Job Employment and Placement. Infosys Digital Solutions disclaims any other advertised or published Applicants List alleged and masterminded by any other third-party whether individual or corporate organization or site other than these outline by this site and shown on this table. kindly contacts the developer any  assistance you might need.</h6>
    <hr> <br /> </form>                    
...
echo "<tr> <th>ID</th> <th>Applicant JOB ID</th><th>Title</th> <th>First Name</th><th>Last Name</th><th>Initials</th><th>Phone Numbers</th><th>Email Address</th><th>Nationality</th> <th>Gender</th><th>Registration Date</th> <th>Delete Applicant</th></tr>";
...
echo '<td><a href="deleteapps.php?id=' . $row['id'] . '">Delete</a></td>';
echo "</tr>";
