...
<body> <form style="width: 90%; padding: 10px; margin-left: auto; margin-right: auto; border: 4px solid #dcd;">
    <h3><p align="center" style="color:white;">JOBS (POSITIONS) AVAILABILITY AND THEIR REQUIREMENTS</p></h3>
<hr>
<h6 style="color:white;">Total Numbers of Jobs created by Administrators and Published to the Applicants' Views. Infosys Digital Solutions disclaims any other advertised or published jobs and vacant positions alleged and masterminded by any other third-party whether individual or corporate organization or site other than these outline by this site and shown on this table. </h6>
<hr> <br />                    
    </form>                  
...
echo "<h5><p align='center' style='color:white;'><b>View All</b> | <a href='../../index.php'><strong>Home</strong></a>&nbsp; | <a href='../managejobs/index.php'><strong>Manage Jobs!</strong></a></p></h5>";


echo "<form style='color:black; background-color:white; width: 98%; padding: 10px; margin-left: auto; margin-right: auto; border: 4px solid #dcd; text-emphasis: bold;' > ";
echo "<table border='1' cellpadding='20'>";


echo "<tr> <th><b>ID</th> <th><b>Job Serial No</th><th><b>Job Category</th><th><b>Job Title</th> <th><b>Job Code</th><th><b>Qualification</th><th><b>Discipline</th><th><b>Years of Experience</th><th><b>Age Limit</th><th><b>Preferred Gender</th> <th><b>Publication Date</th><th><b>Expiring Date</th> <th><b>Edit Jobs</th><th><b>Delete Jobs</b></th></tr>";
...
?>
<hr><hr>
<h5><p align="center"><a href="../../index.php"><strong>Home</strong></a>&nbsp; | <a href="../managejobs/index.php"><strong>Manage Jobs</strong></a></p></h5>
    </form>
