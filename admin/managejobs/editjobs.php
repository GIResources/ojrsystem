...
<form action="" method="post" style= "color:black; background-color:#9bccd8; color:red; width: 50%; padding: 10px; margin-left: auto; margin-right: auto; border: 4px solid #dcd;text-emphasis: bold;">
...
<strong>Job Category: *</strong> <input type="text" name="jobcategory" value="<?php echo $jobcategory; ?>" /><br/>
...
<strong>Discipline: *</strong> <input type="text" name="discipline" value="<?php echo $discipline ?>" /><br/>
...
if ($jobcategory ==''|| $jobtitle ==''|| $jobcode ==''|| $qualification =='' || $discipline =='' ||$yearsofexperience ==''||$agelimit ==''|| $preferredgender ==''|| $publicationdate ==''|| $expiringdate =='')
{
...
renderForm($jobcategory, $jobtitle, $jobcode,$qualification, $discipline, $yearsofexperience, $agelimit,$preferredgender,$publicationdate, $expiringdate, $error);
...
$query = "UPDATE jobtable SET jobcategory = '$jobcategory',jobtitle = '$jobtitle',jobcode = '$jobcode',qualification = '$qualification', discipline = '$discipline',yearsofexperience = '$yearsofexperience',agelimit = '$agelimit',preferredgender = '$preferredgender',publicationdate = '$publicationdate',expiringdate = '$expiringdate' WHERE id='$id' AND job_sn='$job_sn' ";
...
renderForm($id, $job_sn, $jobcategory, $jobtitle, $jobcode,$qualification, $discipline, $yearsofexperience, $agelimit,$preferredgender,$publicationdate, $expiringdate, '');
