...
<form action="" method="POST" style="width: 80%; padding: 10px; margin-left: auto; margin-right: auto; border: 4px solid #dcd; alignment:center;">

    <p align="center" style="padding-left: 10px; padding-right:10px; color: blue; text:center; "><form action="" method="POST">

                            <a href=".././">HOME</a>&nbsp;&nbsp;||&nbsp;&nbsp;<a href=".././managejobs/">BACK</a><BR>

                            <p align="center" ><select name="query" style="padding-left: 10px; padding-right:10px; color: black; text:center; width:40%;">
                    <option value="None" selected>Search for Any Job created by Administrator here...!</option> 
...
<!--<p align="center"><input type="text" name="query" style="width:40%;" placeholder="             Search for Any Job created by Administrator here...!" /></p>  
