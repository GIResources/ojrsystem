    ...
    <div class="container-fluid bg-success">
        ...
        <div class="col-xs-6 col-sm-6 col-md=6">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4><p align="center"><strong class="text-info">INFOSYS JOB CREATIONFEEDBACK</strong></p></h4>
                    </div>
        ...
        <form id="form" method="POST" action="" enctype="multipart/form-data" style="padding-left: 20px; padding-right:20px; color: blue; width:60%; ">
            <p><a href="../index.php"><strong>Admin Login</strong></a></p>
            <p><a href="../../index.php"><strong>Main Home Page</strong></a></p> 
            <p><a href="index.php"><strong>Manage Jobs Home Page</strong></a></p>
        </form>
