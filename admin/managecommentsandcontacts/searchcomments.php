...
<form action="" method="POST" style="width: 40%; padding: 10px; margin-left: auto; margin-right: auto; border: 4px solid #dcd; alignment:center;">

    
                    <p align="center" style="padding-left: 10px; padding-right:10px; color: blue; text:center; "><form action="" method="POST">

                            <a href=".././">HOME</a>&nbsp;&nbsp;||&nbsp;&nbsp;<a href=".././managecommentsandcontacts/">BACK</a><BR>

    <p align="center"><input type="text" name="query" style="width:40%;" placeholder="&nbsp;&nbsp; Search for Comments here...!" /></p>
 
    <p align="center"><input type="submit" class="button" style="font-size:20px;padding-left: 10px; padding-right:10px; width:30%;"value="Search" /></p>
