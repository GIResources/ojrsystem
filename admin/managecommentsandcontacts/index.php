                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h1 class="text-center text-danger"><strong>MANAGE COMMENTS AND CONTACTS MODULE</strong></h1>
    ...
    <div class="container bg-success">
        ...
        <div class="col-xs-10 col-sm-10 col-md=10">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4><p align="center"><strong class="text-info">COMMENTS AND CONTACTS CONTROL PANEL</strong></p></h4>
                    </div>
        ...
        <form id="form" method="POST" action="" enctype="multipart/form-data" style="padding-left: 20px; padding-right:20px; color: blue; width:50%; ">
            ...
            <a href="../managecommentsandcontacts/deletecomments.php"><p align="center"><input type="button" name="admin_reg_submit_btn" value="DELETE COMMENTS" class="btn btn-danger" /></p></a>
            
            <a href="../managecommentsandcontacts/searchcomments.php"><p align="center"><input type="button" name="admin_reg_submit_btn" value="SEARCH COMMENTS" class="btn btn-success" /></p></a>            
            
            <a href="../managecommentsandcontacts/viewcomments.php"><p align="center"><input type="button" name="admin_reg_submit_btn" value="VIEW COMMENTS" class="btn btn-warning" /></p></a>
            
            <a href="../managecommentsandcontacts/printcomments.php"><p align="center"><input type="button" name="admin_reg_submit_btn" value="PRINT COMMENTS" class="btn btn-print" /></p></a>
...
<input type="text" name="query" placeholder="Search Comments Here!" /> <input type="submit" value="Search Comments" class="btn btn-danger" />
...
$email = mysql_real_escape_string(htmlspecialchars($_POST['email']));
   ...
   @ $query = $_POST['query']; 
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($connection, "SELECT * FROM contactus
        ...
        if(mysqli_num_rows($raw_results) > 0){ // if one or more rows are returned do following
            ...
            while($results = mysqli_fetch_array($raw_results)){
				...
				echo "<tr> <th>ID</th> <th>Comment Serial No</th> <th>Name</th> <th>Email Address</th><th>Message and Comments</th> <th>Comment Date and Time</th></tr>";
            // $results = mysql_fetch_array($raw_results) puts data from database into array, while it's valid it does the loop
			 echo "<tr>";
			 // . $row['id'] . '</td>';
                echo '<td>'.$results['id'].'</td>';
				echo '<td>'.$results['contact_id'].'</td>';
				echo '<td>'.$results['name'].'</td>';
				echo '<td>'.$results['email'].'</td>';
				echo '<td>'.$results['message'].'</td>';
				echo '<td>'.$results['commentdate'].'</td>';
...
?>
                    &nbsp;&nbsp; <a href="../../index.php"> <strong>Home</strong></a> &nbsp;&nbsp; || <a href="../index.php"><strong>Dashboard Home</strong></a> &nbsp; &nbsp; || <a href="../managecommentsandcontacts/"><strong>Refresh Page</strong></a>
                    </div>
                </div>
            </div>
