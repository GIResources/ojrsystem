                ...
                <div class="col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h1 class="text-center text-danger"><strong>ADMIN DASHBOARD: SYSTEM OVERVIEW</strong></h1>
...
================================================== -->
    ...
    <div class="container bg-success">
        ...
        <form id="form" method="POST" action="" enctype="multipart/form-data" style="padding-left: 20px; padding-right:20px; color: blue; width:50%; ">
            ...
            <a href="../../appGuide.html"><p align="center"><input type="button" name="admin_reg_submit_btn" value="VIEW APPLICATIONS GUIDE" class="btn btn-warning" /></p></a>
            ...
            <hr> -->
            <a href="../../faq.html"><p align="center"><input type="button" name="admin_reg_submit_btn" value="VIEW F.A.Qs" class="btn btn-print" /></p></a>
