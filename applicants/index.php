...
//Applicant Login begins here....!
    ...
    if(isset($_POST['app_login_btn'])){
        ...
        if(empty($app_login_firstname || $app_login_phone)){
            ...
            $query = " SELECT * FROM register_applicants WHERE firstname = '{$app_login_firstname}' AND phone = '{$app_login_phone}' AND id = '{$check}' ";
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <form id="form" method="POST" action="">
                                ...
                                <p align="center"><input type="submit" class="btn btn-info btn-xl" name="app_login_btn" value="Login" /></p>
                                <hr>
