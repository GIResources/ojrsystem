    ...
    <div class="container-fluid bg-success">
        ...
        <div class="col-xs-6 col-sm-6 col-md=6">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4><p align="center"><strong class="text-info">APPLICATION FORM - PREVIEW AND SUBMIT SECTION</strong></p></h4>
                    </div>
                    ...
                    <hr>
                    <p align="center" style="color:green;"><marquee><strong>Congratulation! Your Passport Upload and Submission was Successful!</strong></marquee></p>
                    
                    <p align="center"><a href="app_previewForm.php"><input type="submit" name="biodata_submit_btn" value="CLICK TO PREVIEW" class="btn btn-info" /></a></p>
