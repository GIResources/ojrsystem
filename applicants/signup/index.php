            ...
            if(mysqli_num_rows($run_query) > 0){
               ...
               $query = "INSERT INTO register_applicants(job_id, title, firstname, lastname, initials, phone, email, nationality, gender) VALUES('{$job_id}','{$app_title}','{$app_fname}','{$app_lname}','{$app_initial}','{$app_phone}','{$app_email}','{$app_nationality}','{$app_gender}')";
                    ...
                    $run_query = mysqli_query($connection, $query);
                       ...
                       // printf("Last Id is %d.\n", mysqli_insert_id($connection)); This returns the id of the last record entered into the Register Applicants Table
                            //$session_check =  mysqli_insert_id($connection);
                            
                            //This stores the id of the last record entered into the Register Applicants table to a global session variable and the session create a variable called session_check and stores the last id in it.
                            $_SESSION["session_check"] = mysqli_insert_id($connection);
                            //var_dump($session_check); This checks to see if the session returns the correct last record id
                            //exit;
                ...
                /// Using associative arrays to fetch individuals field as variables////
                    ...
                    ///redirecting to the login page if the signup was successfu///
                           */ 
                            }
                header("Location: ../index.php");
                        }
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="panel panel-danger">
                        ...
                        <img src="images/roll4.PNG" height="150" width="1300"/>
...
================================================== -->
    ...
    <div class="container-fluid bg-success">
        ...
        <form id="form" method="POST" action="" enctype="multipart/form-data" style="padding-left: 20px; padding-right:20px; color: blue; width:50%; ">
                    ...
                    <p><b>Email</b></p>
                    <input type="email" class="form-control" name="email" placeholder="Please Enter Your Email here...!" required /><br />
                    ...
                    <p align="center"><input type="submit" name="app_reg_submit_btn" value="REGISTER" class="btn btn-danger" /></p>
