...
<?php
    ...
    if(isset($_POST['co_submit_btn'])){
        ...
        if(empty($careerobjective)){
            echo "Please Describe Your Career Objective!";
        }else{
       
            ////Auto-generating Job Serial Numner (sn) for the Job Creation///
            
            $query = " SELECT * FROM careerobjective ";
            ...
            $job_id = $acronym . $increase_num;
               ...
               $query = "INSERT INTO careerobjective(job_id, careerobjective, sess_check) VALUES('{$job_id}','{$careerobjective}','{$check}')";
                        
                    $run_query = mysqli_query($connection, $query);

                        if($run_query == true){
                            echo "Congratulation! Your Career Objective Decription Submission was Successful!";
                            }else{
                                echo "Ooops! Sorry, Career Objective Decription Submission Attempt Failed. Try again!";
                            }
             header("Location: feedback7.php");
                        }
    ...
    <div class="container-fluid bg-success">
        ...
        <div class="col-xs-6 col-sm-6 col-md=6">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4><p align="center"><strong class="text-info">CAREER OBJECTIVE SECTION</strong></p></h4>
                    </div>
        ...
        <form id="form" method="POST" action="" enctype="multipart/form-data" style="padding-left: 20px; padding-right:20px; color: blue; width:70%; ">
                    ...
                    <textarea rows="4" cols="50"  name="careerobjective" placeholder="Please Enter Your Career Objective here...!" required > </textarea><br />
                                              
                    <p align="center"><input type="submit" name="co_submit_btn" value="NEXT" class="btn btn-info" /></p>
