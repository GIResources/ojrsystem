...
<?php
    ...
    if(isset($_POST['jobs_submit_btn'])){
        ...
        if(empty($jobcategory || $desiredjobposition)){
           ...
           $query = "INSERT INTO jobs(job_id,jobcategory,desiredjobposition, sess_check)
                    VALUES('{$job_id}','{$jobcategory}','{$desiredjobposition}','{$check}' )";
                        
                    $run_query = mysqli_query($connection, $query);

                        if($run_query == true){
                            echo "Congratulation! Your Job Category and Position Submission was Successful! Continue filling the next forms!";
                            }else{
                                echo "Ooops! Sorry, Submission Attempt Failed. Try again!";
                            }
    ...
    <div class="container-fluid bg-success">
        ...
        <div class="col-xs-6 col-sm-6 col-md=6">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h4><p align="center"><strong class="text-info">JOB CATEGORY SECTION</strong></p></h4>
                    </div>
        ...
        <form id="form" method="POST" action="" enctype="multipart/form-data" style="padding-left: 20px; padding-right:20px; color: blue; width:70%; ">
                    ...
                    <p align="center"><input type="submit" name="jobs_submit_btn" value="NEXT" class="btn btn-info" /></p>
